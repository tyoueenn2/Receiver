...
1. Apply the [Pi telemetry extension](integrations/pi/README.md) to the separate proxy project at commit `c3c09153feabe4be2eb3a711fe3c3e957f6eb794`. Build/run it with `--enable_injection`. Follow its existing USB setup instructions. Move the physical mouse once after enumeration.
