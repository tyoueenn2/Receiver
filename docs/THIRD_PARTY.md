...
- The Pi extension modifies https://github.com/tyoueenn2/usb-proxy-udp at commit `c3c09153feabe4be2eb3a711fe3c3e957f6eb794`. The proxy retains its Apache-2.0 license; the complete license is included at `../integrations/pi/LICENSE` alongside the extension patch.
